...
function coffee() {
  ...
  if (coffeeC == 5) {
    ...
    document.getElementById("coffee-btn").innerText =
      "Enough! Coffee Drainer 🤣, that was 5th time";
  }
}
var i = 0;
var txt = "Pomodoro Timer 🍅"; /* The text */
var speed = 100; /* The speed/duration of the effect in milliseconds */

function typeWriter() {
  if (i < txt.length) {
    document.getElementById("type-heading").innerHTML += txt.charAt(i);
    i++;
